package io.github.ethanz0x0.nucleus.config.adapters;

import io.github.ethanz0x0.nucleus.config.Configuration;
import io.github.ethanz0x0.nucleus.config.ConfigurationAdapter;
...
public class YamlConfigurationAdapter extends ConfigurationAdapter {
    ...
    public static final YamlConfigurationAdapter INSTANCE = new YamlConfigurationAdapter();
